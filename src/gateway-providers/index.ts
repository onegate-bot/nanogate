...
// This fork's default is its own three-way proxy switch, not upstream's bare
// OneCLI path (see CLAUDE.md "Fork divergences"); NANOCLAW_GATEWAY_PROVIDER
// still overrides it, e.g. back to 'onecli' for upstream's stock behavior.
const DEFAULT_GATEWAY_PROVIDER_KIND = 'onegate';
